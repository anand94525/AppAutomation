package com.apps_auto.mobile.framework.config;
...
public class Constants {
	...
	public final static String CHARLES_PORT_KEY = "CHARLES_PORT";
	public final static int CHARLES_PORT() {
		return Integer.valueOf(Optional.ofNullable(System.getenv(Constants.CHARLES_PORT_KEY)).orElse("8888"));
	}
	...
	public static final String DEFAULT_CAPTURE_ALL_SNAPS = "false";
	...
	public final static String APPIUM_PORT_KEY = "APPIUM_PORT";
	public final static String ADB_PORT_KEY = "ADB_PORT";
	public final static String WDA_PORT_KEY = "WDA_PORT";
	public final static String ANDROID_UDID_KEY = "ANDROID_UDID";
	public final static String ANDROID_ID() {
		return Optional.ofNullable(System.getenv(Constants.ANDROID_UDID_KEY))
				.orElse(PropertiesManager.getCapability("android_caps.properties").get("udid"));
	}
	/* Timeouts */
	...
	public final static long TESTRAIL_SUITE_ID_ANDROID = 3036; // Android New Test
	// Suite - Automation
	public final static long TESTRAIL_SUITE_ID_IOS = 6161; // iOS New Test Suite -
	// Automation
	...
	public final static String TWC_APP_SENSORKIT_ACTIVITY = "com.weather.sensorkit.test/.AutomationTestActivity";
